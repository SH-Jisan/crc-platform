            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                    ...
                    <div className="lg:col-span-7">
                        <h2 className="text-3xl  font-bold text-[#222222] mb-8 border-b-2 border-slate-100 pb-4 inline-block">Latest Events</h2>
                                ...
                                return (
                                    <div key={event.id} className="flex gap-6 items-start group">
                                        ...
                                        <div className="flex-1 pb-6 border-b border-slate-100">
                                            <h3 className="text-xl  font-bold text-[#222222] mb-2 group-hover:text-[#D64A26] transition-colors">{event.title}</h3>
                    ...
                    <div className="lg:col-span-5">
                        <h2 className="text-3xl  font-bold text-[#222222] mb-8 border-b-2 border-slate-100 pb-4 inline-block">About</h2>
                        <div>
                            <h3 className="text-xl  font-bold text-[#222222] mb-6">Come for Road Child (CRC)</h3>
                            <p className="text-[#666666] leading-relaxed mb-6 block prose-p:first-letter:text-[#D64A26] prose-p:first-letter:float-left prose-p:first-letter:text-6xl prose-p:first-letter: prose-p:first-letter:mr-3 prose-p:first-letter:leading-none prose-p:first-letter:mt-1">
                                <span className="text-[#D64A26] float-left text-6xl  mr-3 leading-none mt-1">C</span>RC is a dedicated social welfare organization focusing on the fundamental rights, education, and health of street children. We believe that every child deserves a chance to build a better future, regardless of their background.
                            </p>
