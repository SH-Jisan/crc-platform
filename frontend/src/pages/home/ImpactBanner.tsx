    ...
    return (
        ...
        <div className="relative py-32 bg-[#222222] flex items-center justify-center text-center overflow-hidden bg-[url('https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center bg-fixed">
            ...
            <div className="relative z-20 px-4">
                <h2 className="text-4xl md:text-6xl font-serif italic text-white leading-tight max-w-4xl mx-auto drop-shadow-2xl mb-4">
                    "No one has ever become poor by giving."
                </h2>
                <p className="text-orange-100 font-extrabold uppercase tracking-widest text-xs sm:text-sm drop-shadow-md">— ANNE FRANK</p>
            </div>
        </div>
    );
}