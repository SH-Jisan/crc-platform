            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-8">
                    <div className="text-center px-4">
                        <p className="text-5xl md:text-6xl  font-bold mb-3 bg-gradient-to-r from-[#D64A26] to-[#f6896e] bg-clip-text text-transparent">1.5<span className="text-3xl">M+</span></p>
                    ...
                    <div className="text-center px-4 border-l border-[#333333]">
                        <p className="text-5xl md:text-6xl  font-bold mb-3 bg-gradient-to-r from-[#D64A26] to-[#f6896e] bg-clip-text text-transparent">{children}<span className="text-3xl">+</span></p>
                    ...
                    <div className="text-center px-4 md:border-l border-[#333333] border-l-0">
                        <p className="text-5xl md:text-6xl  font-bold mb-3 bg-gradient-to-r from-[#D64A26] to-[#f6896e] bg-clip-text text-transparent">{volunteers}<span className="text-3xl">+</span></p>
                        <p className="text-slate-300 text-xs font-bold uppercase tracking-widest">Active Volunteers</p>
                    </div>
                    <div className="text-center px-4 border-l border-[#333333]">
                        <p className="text-5xl md:text-6xl  font-bold mb-3 bg-gradient-to-r from-[#D64A26] to-[#f6896e] bg-clip-text text-transparent">{campaigns}</p>
